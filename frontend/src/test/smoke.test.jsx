...
const MOCK_USER = {
  ...
  photo_url: 'https://bucket.example.com/oiueei/users/abc.jpg',
  thumbnail: '',
  koro: 'basic',
...
const MOCK_THING = {
  ...
  location: '',
  condition: '',
  thumbnail_url: 'https://bucket.example.com/oiueei/things/cover.jpg',
  gallery: ['oiueei/things/g1', 'oiueei/things/g2'],
  gallery_urls: [
    'https://bucket.example.com/oiueei/things/g1.jpg',
    'https://bucket.example.com/oiueei/things/g2.jpg',
  ],
...
smokeAndAxe('DataExportPage', DataExportPage);
