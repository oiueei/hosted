...
6. **Entre persones.** Els intercanvis (regals, vendes, préstecs, lloguers, reserves d'espai) són acords entre usuaris: OIUEEI no n'és part, no processa pagaments i no garanteix les transaccions. Una **fiança** anotada en una fitxa és informació que acorden les dues persones entre elles: OIUEEI no la cobra, no la reté, no la mou i no en garanteix la devolució.
