...
**For how long:** as long as you use OIUEEI, and with a period for each kind of data — nothing is kept forever. If nobody signs in to your account for **24 months** I email you, and if you do not come back within the next **30 days** it is deleted (coming back once resets the clock); the exception is an account that owns a group other people are using, which is flagged for a person to decide rather than deleted on its own. An account created by an invitation nobody ever accepted deletes itself after **60 days**. In-app notifications and reports are kept **12 months**, the daily-activity log **26**, and the first-party analytics log stops being tied to a person at **14 months** — the "who" is erased, the fact stays in aggregate. You can **delete your account yourself** (Edit profile → Delete account, with email confirmation): it is immediate and irreversible — your account, your collections, your things and their photos, and your requests are erased. Questions you asked on other people's things and the transfer history stay without your name ("Former member"). Backups are taken daily and rotate on their own: anything older than a week is gone.
...
6. **Between people.** Exchanges (gifts, sales, loans, rentals, on-site reservations) are agreements between users: OIUEEI is not a party to them, processes no payments and does not guarantee transactions. A **deposit** written on a listing is information the two people agree between themselves: OIUEEI does not charge it, hold it, move it, or guarantee that it comes back.
